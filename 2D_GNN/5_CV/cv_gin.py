...
class GIN(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers):
        ...
        self.mlp = MLP([hidden_channels, hidden_channels, out_channels], norm=None, dropout=0.4)
...
for fold, (train_idx, test_idx) in enumerate(kfold.split(graph_list)):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=4.4755e-4, weight_decay=9.8267e-6)
