...
# Reproducibility,Setup and Seed Initialization
...
model = GATv2Model(in_channels=9, hidden_channels=256, out_channels=1, num_layers=6, dropout=0.2, heads=4).to(device)
optimizer = torch.optim.Adam(model.parameters(), lr=0.000044, weight_decay=0.00000486)
